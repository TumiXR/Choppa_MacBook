...
Files: macbook-16.glb [639.28KB] > C:\Users\TUMELO KOLA\WebstormProjects\choppas_website\public\models\macbook-16-transformed.glb [629.72KB] (1%)
        ...
        scene.traverse((child) => {
            if (child.isMesh) {
                if(!noChangeParts.includes(child.name)) {
                    child.material.color = new Three.Color(color);git
                }
            }
        })
    }, [color]);
